...
CStringW C02FloatWnd::m_strName;
CStringW C02FloatWnd::m_strPhone;
CStringW C02FloatWnd::m_strLastTime;
CStringW C02FloatWnd::m_strPricePerSeconds;
CStringW C02FloatWnd::m_strPrice;
...
void C02FloatWnd::getInfo( CStringW &strName, CStringW &strPhone, CStringW &strV1, CStringW &strV2, CStringW &strV3 )
{
	...
	*/
	...
	strPhone = m_strPhone;
	strV1 = m_strLastTime;
	strV2 = m_strPricePerSeconds;
	strV3 = m_strPrice;
}

void C02FloatWnd::setInfo( CStringW &strName, CStringW &strPhone, CStringW &strLastTime, CStringW &strPricePerSeconds, CStringW &strPrice )
{
	m_strName = strName;
	m_strPhone = strPhone;
	m_strLastTime = strLastTime;
	m_strPricePerSeconds = strPricePerSeconds;
	m_strPrice = strPrice;

	wchar_t cStar = L'*';
	if( m_strPhone.GetLength() > 7 )
	{
		m_strPhone.SetAt(3,cStar);
		m_strPhone.SetAt(4,cStar);
		m_strPhone.SetAt(5,cStar);
		m_strPhone.SetAt(6,cStar);
	}
}
